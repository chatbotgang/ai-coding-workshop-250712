...
from internal.domain.auto_reply.webhook_trigger import WebhookTriggerScheduleSettings, WebhookTriggerSetting
...
def validate_trigger(
    ...
    active_triggers = [trigger for trigger in trigger_settings if trigger.enable]
    ...
    for trigger_setting in sorted_triggers:
        ...
        if _evaluate_trigger(
            trigger_setting, auto_reply, message_content, event_time, organization_timezone, ig_story_id
        ):
