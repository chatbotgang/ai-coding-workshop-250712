...
class TestKeywordReplyLogic:
    ...
    def test_prd_b_p0_7_test2_exact_keyword_various_cases(self):
        ...
        for message in test_cases:
            result = validate_trigger(
                [trigger_setting], {1: auto_reply}, message, datetime.now(tz=ZoneInfo("Asia/Taipei")), "Asia/Taipei"
            )
...
class TestMultipleKeywordsSupport:
    ...
    def test_prd_multiple_keywords_test1_multiple_keywords_triggering(self):
        ...
        trigger_setting = WebhookTriggerSetting(
            ...
            bot_id=1,
            enable=True,
            name="Multiple Keywords Trigger",
            event_type=WebhookTriggerEventType.MESSAGE,
            created_at=datetime.now(),
            updated_at=datetime.now(),
        )
        ...
        for keyword in ["hello", "hi", "hey"]:
            result = validate_trigger(
                [trigger_setting], {1: auto_reply}, keyword, datetime.now(tz=ZoneInfo("Asia/Taipei")), "Asia/Taipei"
            )
...
class TestGeneralTimeBasedLogic:
    ...
    def test_prd_b_p0_6_test3_daily_schedule_within_time_window(self):
        ...
        result = validate_trigger(
            [trigger_setting], {1: time_auto_reply}, "any message", outside_time_early, "Asia/Taipei"
        )
        ...
        result = validate_trigger(
            [trigger_setting], {1: time_auto_reply}, "any message", outside_time_late, "Asia/Taipei"
        )
    ...
    def test_prd_b_p0_6_test4_monthly_schedule_on_scheduled_date_time(self):
        ...
        monthly_schedule = MonthlySchedule(day=15, start_time="14:00", end_time="14:30")

        schedule_settings = WebhookTriggerScheduleSettings(schedules=[monthly_schedule])

        time_auto_reply = AutoReply(
            id=1,
            organization_id=1,
            name="Monthly Time Reply",
            status=AutoReplyStatus.ACTIVE,
            event_type=AutoReplyEventType.TIME,
            priority=1,
            keywords=None,
    ...
    def test_prd_b_p0_6_test5_business_hours_during_outside_hours(self):
        ...
        business_hours_schedule = DailySchedule(start_time="09:00", end_time="18:00")

        schedule_settings = WebhookTriggerScheduleSettings(schedules=[business_hours_schedule])
        ...
        business_auto_reply = AutoReply(
            ...
            priority=1,
            keywords=None,
            trigger_schedule_type="business_hour",
            trigger_schedule_settings=schedule_settings,
            created_at=datetime.now(),
            updated_at=datetime.now(),
        )
        ...
        result = validate_trigger(
            [trigger_setting], {1: business_auto_reply}, "any message", during_hours, "Asia/Taipei"
        )
        ...
        result = validate_trigger(
            [trigger_setting], {1: business_auto_reply}, "any message", outside_hours, "Asia/Taipei"
        )
...
class TestMessageContentHandling:
    ...
    def test_prd_message_content_test1_keyword_rule_with_matching_message(self):
        ...
        for message in test_cases:
            result = validate_trigger(
                [trigger_setting],
                {1: keyword_auto_reply},
                message,
                datetime.now(tz=ZoneInfo("Asia/Taipei")),
                "Asia/Taipei",
            )
    ...
    def test_prd_message_content_test3_general_rule_any_content(self):
        ...
        for message in various_messages:
            result = validate_trigger(
                [trigger_setting], {1: general_auto_reply}, message, scheduled_time, "Asia/Taipei"
            )
        ...
        for message in ["hello", "any message"]:
            result = validate_trigger(
                [trigger_setting], {1: general_auto_reply}, message, outside_schedule_time, "Asia/Taipei"
            )
