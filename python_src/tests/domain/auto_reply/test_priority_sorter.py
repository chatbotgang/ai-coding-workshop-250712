...
from internal.domain.auto_reply.webhook_trigger import WebhookTriggerEventType, WebhookTriggerSetting
...
class TestPrioritySorter:
    ...
    def test_mixed_event_types_with_priorities(self):
        ...
        auto_replies = {1: keyword_low_priority, 2: time_high_priority, 3: keyword_high_priority, 4: time_low_priority}
    ...
    def test_missing_auto_reply_handled_gracefully(self):
        ...
        invalid_trigger = WebhookTriggerSetting(
            ...
            bot_id=1,
            enable=True,
            name="Invalid Trigger",  # auto_reply_id not in map
            event_type=WebhookTriggerEventType.MESSAGE,
            created_at=datetime.now(),
            updated_at=datetime.now(),
        )
