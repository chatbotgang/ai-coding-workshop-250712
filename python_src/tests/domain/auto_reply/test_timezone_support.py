...
class TestValidateTriggerTimezone:
    ...
    def test_validate_trigger_with_organization_timezone(self):
        ...
        time_auto_reply = AutoReply(
            id=1, organization_id=1, name="Timezone Test Reply", status=AutoReplyStatus.ACTIVE,
        ...
        trigger_setting = WebhookTriggerSetting(
            id=1, auto_reply_id=1, bot_id=1, enable=True, name="Timezone Test Trigger",
    ...
    def test_validate_trigger_different_timezones(self):
        ...
        time_auto_reply = AutoReply(
            id=1, organization_id=1, name="Multi-Timezone Reply", status=AutoReplyStatus.ACTIVE,
            event_type=AutoReplyEventType.TIME, priority=1, keywords=None,
            trigger_schedule_type="daily", trigger_schedule_settings=schedule_settings,
            created_at=datetime.now(), updated_at=datetime.now()
        )
        ...
        trigger_setting = WebhookTriggerSetting(
            id=1, auto_reply_id=1, bot_id=1, enable=True, name="Multi-Timezone Trigger",
            event_type=WebhookTriggerEventType.TIME,
            created_at=datetime.now(), updated_at=datetime.now()
        )
        ...
        result_taipei = validate_trigger(
            [trigger_setting], {1: time_auto_reply}, "any message", utc_time,
            organization_timezone="Asia/Taipei"
        )
