...
- **Structured AI Collaboration** - Move from "vibe coding" to systematic, intentional AI interactions
- **Design-First Approach** - Plan interfaces and tasks before implementation
- **Quality Assurance** - Validate and test AI-generated code systematically
- **When to Use AI** - Identify tasks that benefit from agentic coding vs. hands-on development
...
| Section | Topic                  | Description                                                                 | Estimated Time |
|---------|------------------------|-----------------------------------------------------------------------------|----------------|
| 1       | Rewrite Brownfield     | Build Omnichannel Auto-Reply trigger logic with agentic coding              | 1h 20m         |
| 2       | Extend Functions       | Extend Omnichannel Auto-Reply to support IG story-specific                  | 40m            |
| 3       | KB Extraction          | Extract knowledge from codebase and tribal knowledge for critical features  | 40m            |
| 4       | Sharpen your prompts   | Patterns for effective agent instructions                                   | 20m            |
